#1)program for all the cases which can check a string contains only a certain set of characters (in this case a-z, A-Z and 0-9).
import re
...
#5) Python program to match a string that contains only uppercase letters
